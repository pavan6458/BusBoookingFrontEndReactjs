...
function CreateBusOperatorModal(props) {
  ...
  const UpdateBusDetails = ()=>{
    ...
    fetch(apiUrl+"api/bus/busOperator/create", requestOptions)
      ...
      >
        <Fade in={props.open}>
          <Box sx={style}>
            ...
            <div>
              <button className="bg-blue-500 rounded  w-full mt-3 h-[35px] text-white active:bg-black font-bold" onClick={UpdateBusDetails}>Create Bus Details</button>
            </div>
            </Typography>
          </Box>
        </Fade>
...
export default CreateBusOperatorModal;
