...
import CreateBusModal from "./CreateBusOperatorModal.jsx";
import BusOperatorModal from "./BusOperatorModal.jsx";
import UpdateBusOperator from "./UpdateBusOperator.jsx";
import Swal from "sweetalert2";
import CreateBusOperatorModal from "./CreateBusOperatorModal.jsx";
...
function BusOperator() {
  ...
  const getAllBuses = () => {
    ...
    fetch(apiUrl + `api/bus/busOperator/All/${adminid}`, requestOptions)
  ...
  const deleteBus = (id) =>{
    ...
    fetch(apiUrl+`api/bus/busOperator/${id}/delete`, requestOptions)
      .then(response => response.json())
  ...
  return (
    <div>
      <>
        ...
        <CreateBusOperatorModal open={scheduleModal} handleClose={handleClose} create={updateBusesList}/>
        <UpdateBusOperator open={updateModal} handleClose={handleClose} updateData ={updateData} Update={updateBusesList}/>
      </>
    </div>
  );
}
